...
interface FoodWasteCardProps {
  ...
  isLoading: boolean;
  wasteRange: 'weekly' | 'monthly' | 'yearly';
  setWasteRange: (range: 'weekly' | 'monthly' | 'yearly') => void;
...
export default function FoodWasteCard({ 
  ...
  return (
    <div className={`relative rounded-xl border bg-white p-5 shadow-sm flex flex-col justify-between h-[120px] ${className}`}>
