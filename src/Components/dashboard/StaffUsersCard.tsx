...
interface StaffUsersCardProps {
  selectedStaffRole: 'all' | 'barangay' | 'admin' | 'operator';
  setSelectedStaffRole: (role: 'all' | 'barangay' | 'admin' | 'operator') => void;
  staffCounts: { all: number; barangay: number; admin: number; operator: number };
  isLoading: boolean;
  className?: string;
}
