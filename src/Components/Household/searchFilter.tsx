      ...
      <div className="flex justify-between items-center">
        ...
        <div className="relative">
          <input
            type="text"
            placeholder="Search"
            className="w-[250px] border border-[#7B9B7B] rounded-md pl-10 pr-4 py-2 text-sm text-[#355842] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#7B9B7B]"
          />
