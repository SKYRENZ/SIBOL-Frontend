...
const WhatIsSibolSection: React.FC = () => {
  return (
    <section
      id="about-section"
      className="h-screen min-h-[700px] max-h-[1080px] px-4 sm:px-6 md:px-8 pt-20 pb-8 sm:pt-32 sm:pb-12 lg:py-20 bg-[#88AB8E] flex flex-col justify-center"
      style={{ scrollSnapAlign: 'start', scrollSnapStop: 'normal' }}
    >
      <div className="max-w-7xl mx-auto w-full">
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-center text-white mb-3 sm:mb-4 md:mb-5">
          What is SIBOL Project?
        </h2>
        <p className="text-center text-white/90 max-w-3xl mx-auto mb-6 sm:mb-10 md:mb-12 leading-relaxed text-sm sm:text-base md:text-lg px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-7 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div className="w-10 h-10 md:w-12 md:h-12 bg-[#2D5F2E] rounded-full flex items-center justify-center mb-2 md:mb-4">
              <Recycle className="w-5 h-5 md:w-6 md:h-6 text-white" />
            </div>
            <h3 className="text-base md:text-xl lg:text-2xl font-bold text-gray-900 mb-1.5 md:mb-2">
